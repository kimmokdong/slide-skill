---
name: helpme-codex
description: A skill to handle tasks by attempting a direct fix in Antigravity or producing a complete Codex handoff prompt.
---
# help me codex skill
...
If the user?셲 request is slightly ambiguous, make a reasonable assumption and continue. Do not stop unless the task is impossible without missing information.
...
When possible, narrow the relevant files to 3?? files.
...
1. Antigravity 遺꾩꽍 以?留욎븯??遺遺?
2. Antigravity 遺꾩꽍 以???멸굅??蹂댁셿??遺遺?
3. 理쒖쥌 ?섏젙 怨꾪쉷
4. 蹂寃쏀븳 ?뚯씪
5. 蹂寃??붿빟
6. ?뚯뒪??寃利?寃곌낵
7. ?⑥? ?꾪뿕 ?붿냼 ?먮뒗 ?섎룞 ?뺤씤 ?꾩슂 ?ы빆
````
